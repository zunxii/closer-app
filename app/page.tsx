...
import { Mail, Send, Users, ArrowRight, Upload } from "lucide-react";
          ...
          <div className="text-center">
            ...
            <div className="mt-24">
              ...
              <p className="text-gray-600 text-center mb-16 max-w-2xl mx-auto">
                Everything you need to manage your business communications and
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="bg-white p-8 rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-200 group">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Efficient bulk sending and campaign management for
                    large-scale operations with detailed analytics.
                  </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-200 group">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Upload MP4 files and extract clean, timestamped
                    transcriptions with one click.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-24 bg-white rounded-2xl border border-gray-200 p-12">
              ...
              <p className="text-gray-600 mb-8 max-w-lg mx-auto">
                Join thousands of professionals who trust Closer for their
                business operations.
              </p>
              <Link
                href="/dashboard"
